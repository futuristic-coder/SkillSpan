      ...
      <nav className={isDark ? "sticky top-0 z-50 border-b border-white/10 bg-slate-950/80 backdrop-blur-xl" : "sticky top-0 z-50 border-b border-slate-300/90 bg-white/85 backdrop-blur-xl"}>
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-2 lg:px-8">
          <Link to="/" className="group flex origin-left items-center gap-3 transform-gpu transition-all duration-300 ease-out hover:animate-[brandPulse_3s_ease-in-out_1]">
            <img src="/logo.png" alt="Logo" className={isDark ? "h-9 w-9 rounded-xl ring-1 ring-white/10 transform-gpu transition-all duration-300 ease-out group-hover:ring-indigo-300/40 group-hover:shadow-lg group-hover:shadow-indigo-500/30" : "h-9 w-9 rounded-xl ring-1 ring-slate-300 transform-gpu transition-all duration-300 ease-out group-hover:ring-indigo-500/40 group-hover:shadow-lg group-hover:shadow-indigo-500/20"} />
            <div className="flex flex-col">
              <span className={isDark ? "inline-block text-base font-semibold tracking-tight text-white transition-all duration-300 ease-out group-hover:text-indigo-200" : "inline-block text-base font-semibold tracking-tight text-slate-900 transition-all duration-300 ease-out group-hover:text-indigo-700"}>Skill Span</span>
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            <button
              ...
              className={isDark ? "inline-flex items-center gap-2 rounded-xl border border-white/15 bg-white/5 px-3 py-1.5 text-sm font-semibold text-slate-100 transition hover:bg-white/10" : "inline-flex items-center gap-2 rounded-xl border border-slate-300 bg-white px-3 py-1.5 text-sm font-semibold text-slate-700 transition hover:bg-slate-50"}
            >
            ...
            <SignInButton mode="modal">
              <button className="group inline-flex items-center gap-2 overflow-hidden rounded-xl bg-indigo-500 px-4 py-1.5 text-sm font-semibold text-white shadow-lg shadow-indigo-900/30 transition hover:bg-indigo-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-300/60">
                Get Started
      ...
      <main className="mx-auto w-full max-w-7xl px-4 pb-24 pt-6 lg:px-8 lg:pt-8">
        <section className="grid items-center gap-10 lg:grid-cols-[1.1fr_.9fr]">
          <div className="space-y-7">
            ...
            <p className={isDark ? "max-w-xl text-base leading-7 text-slate-300 sm:text-lg" : "max-w-xl text-base leading-7 text-slate-600 sm:text-lg"}>
              Skill Span gives your team a polished environment for coding interviews and pair
        ...
        <section className={isDark ? "rounded-3xl border border-white/10 bg-gradient-to-r from-indigo-600/20 via-violet-600/20 to-cyan-600/20 p-8 text-center sm:p-12" : "rounded-3xl border border-indigo-200 bg-gradient-to-r from-indigo-100 via-violet-100 to-cyan-100 p-8 text-center sm:p-12"}>
          <h3 className={isDark ? "text-2xl font-bold text-white sm:text-3xl" : "text-2xl font-bold text-slate-900 sm:text-3xl"}>
            Ready to run your next session on Skill Span?
          </h3>
